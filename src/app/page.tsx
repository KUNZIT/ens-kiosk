  ...
  return (
    <div style={{ textAlign: "center", marginTop: "2rem" }}>
      ...
      <div style={{ display: "flex", width: "100%", marginTop: "2rem" }}>
        ...
        >
          <p>
            Welcome to the ENS snack bar! Simply connect your wallet to check out
            with your ENS profile. Tap the connect button and scan the QR code
            with your mobile wallet. If your name is whitelisted and grado.eth
            follows you on EFP, the app will unlock your snack bag and play
            audio, a notification will appear. This kiosk will automatically
